...
@section('page-header','Tambah Data Mobil')
          ...
          <div class="row">
              ...
              <div class="col-12">
                  <div class="form-group">
                      ...
                      <input type="text" value="{{old('car_name')}}" id="car_name" class="form-control @error('car_name') is-invalid @enderror"
              ...
              <div class="col-12">
                ...
                <div class="input-group mb-3">
                  ...
                  <input type="number" value="{{old('price')}}" class="form-control @error('price') is-invalid @enderror" id="price" name="price" placeholder="Harga / Hari">
                  @error('price') 
                    <div class="invalid-feedback">
                      {{$message}}
                    </div>
              ...
              <div class="col-12">
                  <div class="form-group">
                      ...
                      <input type="text" id="plat_number" value="{{old('plat_number')}}" class="form-control @error('plat_number') is-invalid @enderror" name="plat_number" placeholder="Plat Number Nomor">
                      @error('plat_number') 
                        <div class="invalid-feedback">
                          {{$message}}
                        </div>
